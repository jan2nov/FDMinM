...
write.table(n_keypoints, "orig-diff-orb_n_keypoints.dat", append = FALSE, sep = " ",dec = ".",
...
write.table(test, "orig-diff-orb_results.dat", append = FALSE, sep = " ",dec = ".",
            row.names = FALSE, col.names = TRUE, quote = FALSE)
...
ggplot(temp3, aes(x=y, 
  ...
  labs(colour = "Image #", fill= "Image #", x = "Image ID = position [1mm]", y="Number of matches [%]", title = "Method: ORB, comparing images with etalon")
