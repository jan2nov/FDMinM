...
patient1 = list.files(path = "../data/methods_testing/brisk/atlas/1-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient2 = list.files(path = "../data/methods_testing/brisk/atlas/2-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient3 = list.files(path = "../data/methods_testing/brisk/atlas/3-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient4 = list.files(path = "../data/methods_testing/brisk/atlas/4-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient5 = list.files(path = "../data/methods_testing/brisk/atlas/5-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient6 = list.files(path = "../data/methods_testing/brisk/atlas/6-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
patient7 = list.files(path = "../data/methods_testing/brisk/atlas/7-7/brainweb-orig/", pattern = ".txt",include.dirs = TRUE,full.names = TRUE)
...
graph_hit = expression("A"["5,none"]~"="~"16 %")
graph_cum = expression("C"["none"]~"="~"24196")
